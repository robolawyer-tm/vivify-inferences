...
def run(inference: dict) -> dict:
    ...
    result = call_and_vote(PROMPT.format(text=text), "authority",
...
# llm: claude-opus-5 | 2026-08-13 | repos/vivify-operators/authority_operator.py | parse() records _model beside _operator — which model produced the coordinate
